...
use Datawalke\MainBundle\Entity\Setting;
use Datawalke\MainBundle\Form\SettingType;
...
class SettingController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DatawalkeMainBundle:Setting')->findAll();
     ...
     *
     * @Route("/", name="setting_create")
     * @Method("POST")
     * @Template("DatawalkeMainBundle:Setting:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DatawalkeMainBundle:Setting')->find($id);
    ...
    */
     ...
     *
     * @Route("/{id}", name="setting_update")
     * @Method("PUT")
     * @Template("DatawalkeMainBundle:Setting:edit.html.twig")
     */
