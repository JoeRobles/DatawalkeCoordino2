...
use Datawalke\MainBundle\Entity\History;
use Datawalke\MainBundle\Form\HistoryType;
...
class HistoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DatawalkeMainBundle:History')->findAll();
     ...
     * @Method("POST")
     * @Template("DatawalkeMainBundle:History:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DatawalkeMainBundle:History')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("DatawalkeMainBundle:History:edit.html.twig")
     */
