...
use Datawalke\MainBundle\Entity\Badge;
use Datawalke\MainBundle\Form\BadgeType;
...
class BadgeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DatawalkeMainBundle:Badge')->findAll();
     ...
     * @Method("POST")
     * @Template("DatawalkeMainBundle:Badge:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DatawalkeMainBundle:Badge')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("DatawalkeMainBundle:Badge:edit.html.twig")
     */
