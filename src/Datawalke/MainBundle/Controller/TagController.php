...
use Datawalke\MainBundle\Entity\Tag;
use Datawalke\MainBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DatawalkeMainBundle:Tag')->findAll();
     ...
     * @Method("POST")
     * @Template("DatawalkeMainBundle:Tag:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DatawalkeMainBundle:Tag')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("DatawalkeMainBundle:Tag:edit.html.twig")
     */
